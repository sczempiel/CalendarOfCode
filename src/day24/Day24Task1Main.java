...
public class Day24Task1Main {
	...
	private static List<Units> immuneSystem = new ArrayList<>();
	private static List<Units> infection = new ArrayList<>();
	private static List<Units> allUnits = new ArrayList<>();
	...
	public static void main(String[] args) {
		...
		try {
			...
			int totalHP = allUnits.stream().mapToInt(Units::getCount).sum();
