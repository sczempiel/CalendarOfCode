...
public class Day20Task2Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			printGrid();
			countDoors(minY * -1, minX * -1, minY * -1, minX * -1, 0);
			AdventUtils.publishResult(20, 2, rooms1000);
	...
	private static void printGrid() throws IOException {
		...
		AdventUtils.writeExtra(20, 2, sb.toString(), "grid");
	}
